...
<template>
    <button v-if="showButton" class="layout-config-button p-link" type="button" @click="onConfigButtonClick()">
        <i class="pi pi-cog"></i>
    </button>

    <Sidebar v-model:visible="visible" position="center" :transitionOptions="'.3s cubic-bezier(0, 0, 0.2, 1)'"
        ...
        <template v-if="!simple">
            ...
            <div class="flex">
                ...
                <div class="field-radiobutton flex-1">
                    ...
                    <label for="mode2">Dinâmico</label>
                </div>
            </div>
        </template>
    </Sidebar>

            ...
            <div
                ...
                <div class="w-full surface-card py-8 px-5 sm:px-8 flex flex-column align-items-center"
                    ...
                    <div class="grid flex flex-column align-items-center">
                        ...
                        <span class="text-600 mb-5">Credênciais inválidas. Favor tentar novamente!</span>
                        <img src="/demo/images/error/asset-error.svg" alt="Error" class="mb-5" width="80%" />
                        <div class="col-12 mt-5 text-center">
                            <i class="pi pi-fw pi-arrow-left text-blue-400 font-bold mr-2"
                               style="vertical-align: center"></i>
                            <router-link to="/auth/login" class="text-blue-400 font-bold">Tentar novamente</router-link>
                        </div>
                    </div>
                </div>
            </div>
